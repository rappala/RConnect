...
Toolbar mToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView img_venk = (ImageView) findViewById(R.id.venkatimg);
        ImageView img_ram = (ImageView) findViewById(R.id.img_ram);
        Bitmap img_bitmap_ram = BitmapFactory.decodeResource(getResources(), R.mipmap.rambo);
        Bitmap img_bitmap_venk = BitmapFactory.decodeResource(getResources(), R.mipmap.linkedin);
        img_venk.setImageBitmap(ImageHelper.getRoundedCornerBitmap(img_bitmap_venk, 20));
        img_ram.setImageBitmap(ImageHelper.getRoundedCornerBitmap(img_bitmap_ram,20));
    }
