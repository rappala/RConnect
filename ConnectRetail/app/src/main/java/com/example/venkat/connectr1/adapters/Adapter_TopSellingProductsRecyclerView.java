 ...
 */
public class Adapter_TopSellingProductsRecyclerView extends  RecyclerView.Adapter<Adapter_TopSellingProductsRecyclerView.ViewHolder> {
    ...
    public Adapter_TopSellingProductsRecyclerView(Context myContext, List<Map<String, ?>> myDataSet) {
        dataSet = myDataSet;
        context = myContext;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bindMovieData(Map<String, ?> movie) {
            ...
            String s = df.format((Double) movie.get("customerRating"));
            rating.setText(s);
    ...
    @Override
    public Adapter_TopSellingProductsRecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View v;
                   v = LayoutInflater.from(parent.getContext()).
                        inflate(R.layout.cardview_top_selling_products,parent,false);
