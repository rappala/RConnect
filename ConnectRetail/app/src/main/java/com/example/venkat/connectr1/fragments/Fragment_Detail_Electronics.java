 ...
 * {@link Fragment_Detail_Electronics.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Fragment_Detail_Electronics#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Fragment_Detail_Electronics extends Fragment {
    ...
    public static Fragment_Detail_Electronics newInstance(String param1, String param2) {
        Fragment_Detail_Electronics fragment = new Fragment_Detail_Electronics();
    ...
    public Fragment_Detail_Electronics() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_detail_electronics, container, false);
       ...
       //vDescription = (TextView) rootView.findViewById(R.id.ItemDescription_detail_electronics);
        ...
        item_cart = (ImageView) rootView.findViewById(R.id.item_cart);
...
//    }
    ...
    public static Fragment_Detail_Electronics newInstance(HashMap<String,?> electronicitemInfo){
        Fragment_Detail_Electronics fragment = new Fragment_Detail_Electronics();
        Bundle args = new Bundle();
