...
//        recyclerView.getItemAnimator().setChangeDuration(1000);
        ...
        String url = ElectronicsInfoFromJSON.ELECTRONICSJSON_API;
        elecJSONDownloadAsync.execute(new String[]{url});
        recyclerView.setAdapter(electronics_adapter);

       // recyclerView.setAdapter(new AlphaInAnimationAdapter(electronics_adapter));
    ...
    public static Fragment_Electronics newInstance() {
        return new Fragment_Electronics();
    }
