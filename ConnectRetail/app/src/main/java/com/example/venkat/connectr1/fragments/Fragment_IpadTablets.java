...
import com.example.venkat.connectr1.json.IpadTabletsInfoFromJSON;
 ...
 */
public class Fragment_IpadTablets extends Fragment {
...
//        dialog.setMessage("loading Ipads and Tablets");
//        dialog.show();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String url = IpadTabletsInfoFromJSON.IPADTABLETSJSON_API;
...
//        dialog.dismiss();
    ...
    public static Fragment_IpadTablets newInstance() {
        return new Fragment_IpadTablets();
    }
