 ...
 * {@link Fragment_NewArrivalProducts.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Fragment_NewArrivalProducts#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Fragment_NewArrivalProducts extends Fragment {
...
//    private Double msrp;
    ...
    public static Fragment_NewArrivalProducts newInstance(String param1, String param2) {
        Fragment_NewArrivalProducts fragment = new Fragment_NewArrivalProducts();
    ...
    public Fragment_NewArrivalProducts() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_new_arrival_products_grid, container, false);
       // ImageView share_image = (ImageView) rootView.findViewById(R.id.share_button_recyclerview);
...
//        vRatingBar = (RatingBar) rootView.findViewById(R.id.CustomerRating_detail_electronics);
        ...
        if(electronic_item!=null)
        {
            ...
            //share_image.setImageResource(R.drawable.ic_share_black_24dp);
...
//    }
    ...
    public static Fragment_NewArrivalProducts newInstance(HashMap<String,?> electronicitemInfo){
        Fragment_NewArrivalProducts fragment = new Fragment_NewArrivalProducts();
        Bundle args = new Bundle();
