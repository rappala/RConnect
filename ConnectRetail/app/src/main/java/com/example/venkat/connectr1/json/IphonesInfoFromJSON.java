 ...
 */
public class IphonesInfoFromJSON {
    public static String IPHONESJSON_API = "http://api.walmartlabs.com/v1/paginated/items?format=json&category=1105910_1127173&apiKey=seuyq22f8ejzzvq4fdxuh3zd";
    ...
    public void dowloadElectronicsinfoJSON(String json_url) {
       ...
       // Double standshiprate = 0.00000;
        ...
        if (electronicsJSON == null) {
            Log.d("MyDebugMsg", "Having trouble loading URL: " + IPHONESJSON_API);
            return;
        }
