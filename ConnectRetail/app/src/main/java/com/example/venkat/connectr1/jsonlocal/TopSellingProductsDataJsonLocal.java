...
public class TopSellingProductsDataJsonLocal {
    List<Map<String,?>> OfferProductsList;

    public List<Map<String, ?>> getTopSellingProductsList() {
    ...
    public TopSellingProductsDataJsonLocal() {
    ...
    public void loadLocalMovieDataJson(Context context) {
        ...
        String offerProductsArray = loadFileFromAsset(context, "topSellingProducts.json");
